...
att.UBGL_MuzzleEffect = "wpn_muzzleflash_dc17"
...
local function Ammo(wep)
    return (pretty:GetBool() and 9999 or wep:GetOwner():GetAmmoCount("Grenade"))
end
...
att.ToggleStats = {
    {
        PrintName = "Dioxis Grenade",
        UBGL_Entity = "nade_poison"
    },
    {
        PrintName = "Impact Grenade",
        UBGL_Entity = "nade_impact"
    },
    {
        PrintName = "Smoke Grenade",
        UBGL_Entity = "nade_smoke"
    },
    {
        PrintName = "Bacta Grenade",
        UBGL_Entity = "nade_heal"
    }
}