...
SWEP.IconOverride = "entities/masita/ec17.png"
...
SWEP.FirstShootSound = "weapons/ec17/ec17.mp3"
SWEP.ShootSound = "weapons/ec17/ec17.mp3"
...
-- Attachments
SWEP.DefaultElements = {"ec17", "muzzle"}
SWEP.AttachmentElements = {
    ["ec17"] = {
        VMElements = {
            {
                Model = "models/arccw/masita/rising/w_ec17.mdl",
                Bone = "v_scoutblaster_reference001",
                Scale = Vector(1.2, 1.2, 1.2),
                Offset = {
                    pos = Vector(1.6, -6, 2.6),
                    ang = Angle(0, 180, 0)
                }
            }
        },
...
}WMOverride = "models/arccw/masita/rising/w_ec17.mdl"
...
SWEP.Attachments = {     
    ...
    },
    {
        ...
        Bone = "v_scoutblaster_reference001",
        Offset = {
            vpos = Vector(0.050, -4.7, 1.5),
            vang = Angle(0, 90, 0),
            wpos = Vector(920, 190, -350),
            wang = Angle(0, 0, 180)
        },
    },  
    {
    ...
    },    
    {
        ...
        Bone = "v_scoutblaster_reference001",
        Offset = {
            vpos = Vector(-1.1, -3, 1.6),
            vang = Angle(0, 90, 0),
            wpos = Vector(700, 320, -350),
            wang = Angle(0 , 0, 180)
        },
    },    
    {
