...
SWEP.IconOverride = "entities/masita/c88.png"
...
SWEP.FirstShootSound = "weapons/c88/c88.mp3"
SWEP.ShootSound = "weapons/c88/c88.mp3"
...
-- Attachments
SWEP.DefaultElements = {"c88", "muzzle"}
SWEP.AttachmentElements = {
    ["c88"] = {
        VMElements = {
            {
                Model = "models/arccw/masita/rising/w_c88.mdl",
                Bone = "v_dlt19_reference001",
                Scale = Vector(1.2, 1.2, 1.2),
                Offset = {
                    pos = Vector(-0.5, 9, 2.3),
                    ang = Angle(0, 0.65, -2)
                }
            }
        },
...
}WMOverride = "models/arccw/masita/rising/w_c88.mdl"
...
SWEP.Attachments = {     
    {
        ...
        Bone = "v_dlt19_reference001",
        Offset = {
            vpos = Vector(2.1, 17, 3),
            vang = Angle(0, -90, 90),
            wpos = Vector(2200, 280, -850),
            wang = Angle(-15, 0, -90)
        },
    },
    {
    ...
    },    
    {
        ...
        Bone = "v_dlt19_reference001",
        Offset = {
            vpos = Vector(1, 12.1, 2.8),
            vang = Angle(0, -90, 0),
            wpos = Vector(1700, 180, -710),
            wang = Angle(-15, 0, 180)
        },
    },    
    {
        ...
        Bone = "v_dlt19_reference001",
        Offset = {
            vpos = Vector(1.6, 5, 1.5),
            vang = Angle(20, -90, 0),
            wpos = Vector(800, 240, -300),
            wang = Angle(-15, 0, 180)
        },
    },   
}
