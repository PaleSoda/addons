...
SWEP.IconOverride = "entities/masita/a180_sniper.png"
...
SWEP.FirstShootSound = "weapons/a-180/blasters_a180_laser_close_var_01.mp3"
SWEP.ShootSound = "weapons/a-180/blasters_a180_laser_close_var_02.mp3"
...
SWEP.Attachments = {     
    ...
    },
    {
        ...
        Bone = "v_dlt19_reference001",
        Offset = {
            vpos = Vector(0.4, 42.2, 3.5),
            vang = Angle(0, -90, 0),
            wpos = Vector(5200, 70, -1310),
            wang = Angle(-10, 0, 0)
        },
    },  
    {
    ...
    },    
    {
        ...
        Bone = "v_dlt19_reference001",
        Offset = {
            vpos = Vector(1.5, -3, 1.4),
            vang = Angle(0, -90, 0),
            wpos = Vector(-100, 230, -300),
            wang = Angle(-10, 0, 180)
        },
    },   
}
