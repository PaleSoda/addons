...
SWEP.AttachmentElements = {
    ["e11"] = {
        VMElements = {
            {
                Model = "models/arccw/masita/tie_pilot_blaster/tie_pilot_blaster.mdl",
...
}WMOverride = "models/arccw/masita/tie_pilot_blaster/tie_pilot_blaster.mdl"
...
SWEP.Attachments = {     
    {
        ...
        Offset = {
            vpos = Vector(-0.3, -1.5, 3.2),
            vang = Angle(0, 90, 0),
            wpos = Vector(700, 100, -520),
            wang = Angle(0, 0, 180)
        },
    ...
    },
    {
        ...
        Bone = "v_scoutblaster_reference001",
        Offset = {
            vpos = Vector(-1.1, -4, 2.3),
            vang = Angle(-90, 90, 0),
            wpos = Vector(900, 190, -430),
            wang = Angle(0, 0, -90)
        },
    },
    {
        ...
        Bone = "v_scoutblaster_reference001",
        Offset = {
            vpos = Vector(-0.3, -7.8, 2.1),
            vang = Angle(0, 90, 0),
            wpos = Vector(1350, 90, -385),
            wang = Angle(0, 0, 180)
        },
    },  
    {
    ...
    },    
    {
        ...
        Bone = "v_scoutblaster_reference001",
        Offset = {
            vpos = Vector(-1.1, 1, 1.5),
            vang = Angle(0, 90, 0),
            wpos = Vector(450, 180, -320),
            wang = Angle(0 , 0, 180)
        },
    },    
    {
        ...
        Bone = "v_scoutblaster_reference001",
        Offset = {
            vpos = Vector(-1.15, 0.3, 2.35),
            vang = Angle(0, 90, 0),
            wpos = Vector(400, 190, -420),
            wang = Angle(0 , 0, 180)
        },
    },   
}
