...
SWEP.IconOverride = "entities/masita/sx21.png"
...
SWEP.FirstShootSound = "weapons/sx21/sx21.wav"
SWEP.ShootSound = "weapons/sx21/sx21.wav"
...
SWEP.AttachmentElements = {
    ["sx21"] = {
        VMElements = {
            {
                Model = "models/arccw/masita/rising/w_sx21.mdl",
...
}WMOverride = "models/arccw/masita/rising/w_sx21.mdl"
...
SWEP.Attachments = {     
    ...
    },
    {
        ...
        Bone = "v_dlt19_reference001",
        Offset = {
            vpos = Vector(1.4, 18, 4.2),
            vang = Angle(0, -90, 90),
            wpos = Vector(2500, 210, -750),
            wang = Angle(0, 0, -90)
        },
    },
    {
        ...
        VMScale = Vector(2.2, 2.2, 2.2),
        Bone = "v_dlt19_reference001",
        Offset = {
            vpos = Vector(0.3, 28.5, 4.3),
            vang = Angle(0, -90, 0),
            wpos = Vector(3675, 90, -720),
            wang = Angle(0, 0, 0)
        },
    },  
    {
    ...
    },    
    {
        ...
        Bone = "v_dlt19_reference001",
        Offset = {
            vpos = Vector(0.9, 3.5, 1.8),
            vang = Angle(0, -90, 0),
            wpos = Vector(860, 185, -450),
            wang = Angle(0 , 0, 180)
        },
    },    
    {
