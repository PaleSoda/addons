...
SWEP.PrintName = "Pistol E-11 Extended"
...
SWEP.IconOverride = "entities/masita/e11_pistolext.png"
...
SWEP.AttachmentElements = {
    ["e11"] = {
        VMElements = {
            {
                Model = "models/arccw/masita/rising/w_e11_pistol.mdl",
                Bone = "v_scoutblaster_reference001",
                ModelBodygroups = "00000012",
                Scale = Vector(1, 1, 1),
                Offset = {
                    pos = Vector(1, -6.5, 2.3),
                    ang = Angle(0, 180, 0)
                }
            }
        },
...
}WMOverride = "models/arccw/masita/rising/w_e11_pistol.mdl"
...
SWEP.Attachments = {     
    ...
    },
    {
        ...
        Bone = "v_scoutblaster_reference001",
        Offset = {
            vpos = Vector(-0.8, -7, 2.2),
            vang = Angle(-90, 90, 0),
            wpos = Vector(1400, 220, -480),
            wang = Angle(0, 0, -90)
        },
    },
    {
        ...
        Bone = "v_scoutblaster_reference001",
        Offset = {
            vpos = Vector(0, -10, 2.2),
            vang = Angle(0, 90, 0),
            wpos = Vector(1550, 125, -465),
            wang = Angle(0, 0, 180)
        },
    },  
    {
    ...
    },    
    {
        ...
        Bone = "v_scoutblaster_reference001",
        Offset = {
            vpos = Vector(-1.1, 2, 1.7),
            vang = Angle(0, 90, 0),
            wpos = Vector(0, 260, -380),
            wang = Angle(0 , 0, 180)
        },
    },    
    {
