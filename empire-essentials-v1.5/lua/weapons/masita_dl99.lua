...
SWEP.IconOverride = "entities/masita/dl99.png"
...
-- Attachments
SWEP.DefaultElements = {"dl99", "muzzle"}
SWEP.AttachmentElements = {
    ["dl99"] = {
        VMElements = {
            {
                Model = "models/arccw/masita/rising/w_dl99.mdl",
...
}WMOverride = "models/arccw/masita/rising/w_dl99.mdl"
...
SWEP.Attachments = {     
    {
        ...
        Offset = {
            vpos = Vector(0.050, -2.5, 3),
            vang = Angle(0, 90, 0),
            wpos = Vector(500, 160, -620),
            wang = Angle(0, 0, 180)
        },
    ...
    },    
    {
        ...
        Bone = "v_scoutblaster_reference001",
        Offset = {
            vpos = Vector(-0.6, -4.3, 1.3),
            vang = Angle(0, 90, 0),
            wpos = Vector(900, 250, -360),
            wang = Angle(0, 0, 180)
        },
    },    
    {
        ...
        Bone = "v_scoutblaster_reference001",
        Offset = {
            vpos = Vector(-0.350, 0, 2.5),
            vang = Angle(0, 90, 0),
            wpos = Vector(350, 220, -500),
            wang = Angle(0, 0, 180)
        },
    },   
}
