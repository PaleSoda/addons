...
SWEP.IconOverride = "entities/masita/dlt19x.png"
...
SWEP.FirstShootSound = "weapons/dlt19x/dlt19x.mp3"
SWEP.ShootSound = "weapons/dlt19x/dlt19x.mp3"
SWEP.ShootSoundSilenced = "weapons/dlt19x/dlt19x.mp3"
...
SWEP.AttachmentElements = {
    ["dlt19"] = {
        VMElements = {
            {
                Model = "models/arccw/masita/rising/w_dlt19x.mdl",
...
}WMOverride = "models/arccw/masita/rising/w_dlt19x.mdl"
...
SWEP.Attachments = {     
    {
        ...
        Offset = {
            vpos = Vector(0.3, 4, 3.5),
            vang = Angle(0, -90, 0),
            wpos = Vector(1050, 100, -770),
            wang = Angle(0 , 0, 180)
        },
