...
SWEP.IconOverride = "entities/masita/dh17.png"
...
SWEP.AttachmentElements = {
    ["dh17"] = {
        VMElements = {
            {
                Model = "models/arccw/masita/rising/w_dh17.mdl",
...
}WMOverride = "models/arccw/masita/rising/w_dh17.mdl"
...
SWEP.Attachments = {     
    {
        ...
        Offset = {
            vpos = Vector(-0.1, 1, 3.4),
            vang = Angle(0, 90, 0),
            wpos = Vector(200, 180, -560),
            wang = Angle(0, 0, 180)
        },
    ...
    },    
    {
        ...
        Bone = "v_scoutblaster_reference001",
        Offset = {
            vpos = Vector(-0.3, -2.5, 1.2),
            vang = Angle(0, 90, 0),
            wpos = Vector(560, 240, -270),
            wang = Angle(0, 0, 180)
        },
    },    
    {
        ...
        Bone = "v_scoutblaster_reference001",
        Offset = {
            vpos = Vector(-0.5, -3.6, 3.3),
            vang = Angle(0, 90, 0),
            wpos = Vector(700, 220, -520),
            wang = Angle(0, 0, 180)
        },
    },   
}
