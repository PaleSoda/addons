...
SWEP.PrintName = "Shoretrooper Blaster"
...
SWEP.IconOverride = "entities/masita/shorepistol.png"
...
SWEP.FirstShootSound = "weapons/empire_e_series/pistol/blasters_e11-leia_laser_close_var_01.mp3"
SWEP.ShootSound = "weapons/empire_e_series/pistol/blasters_e11-leia_laser_close_var_05.mp3"
...
SWEP.AttachmentElements = {
    ["e11"] = {
        VMElements = {
            {
                Model = "models/arccw/masita/shoretrooper_pistol/shoretrooper_pistol.mdl",
...
}WMOverride = "models/arccw/masita/shoretrooper_pistol/shoretrooper_pistol.mdl"
...
SWEP.Attachments = {     
    {
        ...
        Offset = {
            vpos = Vector(-0.3, -1.5, 3),
            vang = Angle(0, 90, 0),
            wpos = Vector(320, 155, -555),
            wang = Angle(0, 0, 180)
        },
    ...
    },
    {
        ...
        Bone = "v_scoutblaster_reference001",
        Offset = {
            vpos = Vector(-0.9, -6, 2.35),
            vang = Angle(-90, 90, 0),
            wpos = Vector(1050, 220, -480),
            wang = Angle(0, 0, -90)
        },
    },
    {
        ...
        Bone = "v_scoutblaster_reference001",
        Offset = {
            vpos = Vector(-0.3, -7.3, 2.2),
            vang = Angle(0, 90, 0),
            wpos = Vector(1220, 150, -470),
            wang = Angle(0, 0, 180)
        },
    },  
    {
    ...
    },    
    {
        ...
        Bone = "v_scoutblaster_reference001",
        Offset = {
            vpos = Vector(-1.25, 2.1, 1.7),
            vang = Angle(0, 90, 0),
            wpos = Vector(175, 245, -385),
            wang = Angle(0 , 0, 180)
        },
    },    
    {
