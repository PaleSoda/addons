...
SWEP.IconOverride = "entities/masita/purge_dc15s.png"
...
SWEP.FirstShootSound = "weapons/dc15/dc15s.wav"
SWEP.ShootSound = "weapons/dc15/dc15s.wav"
...
SWEP.AttachmentElements = {
    ["dc15"] = {
        VMElements = {
            {
                Model = "models/arccw/masita/rising/w_dc15a.mdl",
                Bone = "v_e11_reference001",
                Scale = Vector(1.1, 1.1, 1.1),
                Offset = {
                    pos = Vector(-1.7, 5.4, 1.9),
                    ang = Angle(0, 0.65, -2)
                }
            }
        },
...
}WMOverride = "models/arccw/masita/rising/w_dc15a.mdl"
...
SWEP.Attachments = {     
    {
        ...
        Offset = {
            vpos = Vector(-0.050, 1.5, 3),
            vang = Angle(90, 0, -90),
            wpos = Vector(650, 150, -520),
            wang = Angle(-15 , 0, 180)
        },
    },
    {
        ...
        Bone = "e11_sight",
        Offset = {
            vpos = Vector(0.7, 2, 13.2),
            vang = Angle(90, 0, 0),
            wpos = Vector(1600, 220, -680),
            wang = Angle(-15, 0, -90)
        },
    },
    {
        ...
        Bone = "e11_sight",
        Offset = {
            vpos = Vector(0.3, 2, 16.2),
            vang = Angle(90, 0, -90),
            wpos = Vector(2050, 150, -790),
            wang = Angle(-15, 0, 0)
        },
    },  
    {
    ...
    },    
    {
        ...
        Bone = "e11_sight",
        Offset = {
            vpos = Vector(1, 3.1, 0.050),
            vang = Angle(90, 0, -90),
            wpos = Vector(750, 240, -250),
            wang = Angle(-15 , 0, 180)
        },
    },    
    {
