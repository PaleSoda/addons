...
SWEP.IconOverride = "entities/masita/westarm6.png"
...
SWEP.FirstShootSound = "weapons/westar/westar.wav"
SWEP.ShootSound = "weapons/westar/westar.wav"
...
-- Attachments
SWEP.DefaultElements = {"westar", "muzzle"}
SWEP.AttachmentElements = {
    ["westar"] = {
        VMElements = {
            {
                Model = "models/arccw/masita/sw_battlefront/weapons/new/westar_m5_blaster_rifle.mdl",
                Bone = "v_dlt19_reference001",
                Scale = Vector(1, 1, 1),
                ModelBodygroups = "111111",
                Offset = {
                    pos = Vector(0.7, 4.8, 0.7),
                    ang = Angle(0, 180, 0)
                }
            }
        },
...
}WMOverride = "models/arccw/masita/sw_battlefront/weapons/new/westar_m5_blaster_rifle.mdl"
...
SWEP.Attachments = {     
    {
        ...
        Offset = {
            vpos = Vector(0.2, 5, 4.9),
            vang = Angle(0, -90, 0),
            wpos = Vector(800, 90, -860),
            wang = Angle(-15 , 0, 180)
        },
    ...
    },
    {
        ...
        Bone = "v_dlt19_reference001",
        Offset = {
            vpos = Vector(0.9, 16, 1.9),
            vang = Angle(0, -90, 90),
            wpos = Vector(1800, 120, -780),
            wang = Angle(-15, 0, -90)
        },
    },
    {
        ...
        Bone = "v_dlt19_reference001",
        Offset = {
            vpos = Vector(0.3, 20, 3.3),
            vang = Angle(0, -90, 0),
            wpos = Vector(2450, 90, -1125),
            wang = Angle(-15, 0, 180)
        },
    },  
    {
    ...
    },    
    {
        ...
        Bone = "v_dlt19_reference001",
        Offset = {
            vpos = Vector(1.8, 0.9, 3.9),
            vang = Angle(0, -90, 0),
            wpos = Vector(285, 265, -600),
            wang = Angle(-15 , 0, 180)
        },
    },    
    {
        ...
        Bone = "v_dlt19_reference001",
        Offset = {
            vpos = Vector(1, -1.3, 3.9),
            vang = Angle(40, -90, 0),
            wpos = Vector(0, 180, -490),
            wang = Angle(-15 , 0, 180)
        },
    },   
}
