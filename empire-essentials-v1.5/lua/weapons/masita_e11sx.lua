...
SWEP.IconOverride = "entities/masita/e11sx.png"
...
SWEP.FirstShootSound = "weapons/misc_sniper/awp1.wav"
SWEP.ShootSound = "weapons/misc_sniper/awp1.wav"
...
SWEP.AttachmentElements = {
    ["e11s"] = {
        VMElements = {
            {
                Model = "models/arccw/masita/rising/w_e11s.mdl",
                Bone = "v_e11_reference001",
                ModelBodygroups = "00000111",
                Scale = Vector(1, 1, 1),
                Offset = {
...
}WMOverride = "models/arccw/masita/rising/w_e11s.mdl"
...
SWEP.Attachments = {     
    ...
    },
    {
        ...
        Bone = "e11_sight",
        Offset = {
            vpos = Vector(-0.2, 1.4, 29.2),
            vang = Angle(90, 0, -90),
            wpos = Vector(3520, 110, -1150),
            wang = Angle(-15, 0, 0)
        },
    },  
    {
