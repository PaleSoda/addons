...
SWEP.IconOverride = "entities/masita/blurg.png"
...
SWEP.FirstShootSound = "weapons/blurrg-1120/blasters_blurrg1120_laser_close_var_02.mp3"
SWEP.ShootSound = "weapons/blurrg-1120/blasters_blurrg1120_laser_close_var_06.mp3"
...
SWEP.Attachments = {     
    ...
    },
    {
        ...
        Bone = "v_scoutblaster_reference001",
        Offset = {
            vpos = Vector(-0.2, -5.4, 2.8),
            vang = Angle(0, 90, 0),
            wpos = Vector(1050, 120, -560),
            wang = Angle(0, 0, 180)
        },
    },  
    {
