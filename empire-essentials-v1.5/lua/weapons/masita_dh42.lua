...
SWEP.IconOverride = "entities/masita/dh42.png"
...
SWEP.FirstShootSound = "weapons/dh42/dh42.wav"
SWEP.ShootSound = "weapons/dh42/dh42.wav"
...
-- Attachments
SWEP.DefaultElements = {"dh42", "muzzle"}
SWEP.AttachmentElements = {
    ["dh42"] = {
        VMElements = {
            {
                Model = "models/arccw/masita/rising/w_dh42.mdl",
                Bone = "v_scoutblaster_reference001",
                Scale = Vector(1.1, 1.1, 1.1),
                Offset = {
                    pos = Vector(0.5, -7, 2.3),
                    ang = Angle(0, 180, 0)
                }
            }
        },
...
}WMOverride = "models/arccw/masita/rising/w_dh42.mdl"
...
SWEP.Attachments = {     
    {
        ...
        Offset = {
            vpos = Vector(-0.225, -2, 3),
            vang = Angle(0, 90, 0),
            wpos = Vector(750, 100, -578),
            wang = Angle(0, 0, 180)
        },
    ...
    },
    {
        ...
        Bone = "v_scoutblaster_reference001",
        Offset = {
            vpos = Vector(-0.2, -7, 1.6),
            vang = Angle(0, 90, 0),
            wpos = Vector(1300, 100, -390),
            wang = Angle(0, 0, -180)
        },
    },
    {
    ...
    },    
    {
        ...
        Bone = "v_scoutblaster_reference001",
        Offset = {
            vpos = Vector(-0.7, 1.3, 2.4),
            vang = Angle(0, 90, 0),
            wpos = Vector(200, 160, -480),
            wang = Angle(0 , 0, 180)
        },
    },    
    {
        ...
        Bone = "v_scoutblaster_reference001",
        Offset = {
            vpos = Vector(-0.6, -3.6, 1.3),
            vang = Angle(0, 90, 0),
            wpos = Vector(900, 140, -320),
            wang = Angle(0 , 0, 180)
        },
    },   
}
