...
SWEP.IconOverride = "entities/masita/valken38_sniper.png"
...
SWEP.FirstShootSound = "weapons/valken38/valken.wav"
SWEP.ShootSound = "weapons/valken38/valken.wav"
...
-- Attachments
SWEP.DefaultElements = {"valken38", "muzzle"}
SWEP.AttachmentElements = {
    ["valken38"] = {
        VMElements = {
            {
                Model = "models/arccw/masita/rising/w_valken38.mdl",
                Bone = "v_dlt19_reference001",
                Scale = Vector(1.1, 1.1, 1.1),
                Offset = {
                    pos = Vector(-0.9, 6, 1.6),
                    ang = Angle(0, 0.65, -2)
                }
            }
        },
...
}WMOverride = "models/arccw/masita/rising/w_valken38.mdl"
...
SWEP.Attachments = {     
    ...
    },
    {
        ...
        Bone = "v_dlt19_reference001",
        Offset = {
            vpos = Vector(1.1, 20, 2.5),
            vang = Angle(0, -90, 90),
            wpos = Vector(3000, 180, -500),
            wang = Angle(0, 0, -90)
        },
    },
    {
        ...
        Bone = "v_dlt19_reference001",
        Offset = {
            vpos = Vector(0.250, 32.6, 2.9),
            vang = Angle(0, -90, 0),
            wpos = Vector(4250, 80, -500),
            wang = Angle(0, 0, 0)
        },
    },  
    {
    ...
    },    
    {
        ...
        Bone = "v_dlt19_reference001",
        Offset = {
            vpos = Vector(0.8, 2.5, 0.7),
            vang = Angle(0, -90, 0),
            wpos = Vector(580, 190, -350),
            wang = Angle(0 , 0, 180)
        },
    },    
    {
