...
SWEP.Trivia_Class = "Blaster Rifle Elite"
...
SWEP.IconOverride = "entities/masita/e105e.png"
...
-- Attachments
SWEP.DefaultElements = {"e10r", "muzzle"}
SWEP.AttachmentElements = {
    ["e10r"] = {
        VMElements = {
            {
                Model = "models/arccw/masita/e10e/e10r.mdl",
...
}WMOverride = "models/arccw/masita/e10e/e10r.mdl"
...
SWEP.Attachments = {     
    {
        ...
        Offset = {
            vpos = Vector(-0.05, 0.8, -1),
            vang = Angle(90, 0, -90),
            wpos = Vector(400, 50, -520),
            wang = Angle(-15, 0, 180)
        },
    },
    {
        ...
        Bone = "e11_sight",
        Offset = {
            vpos = Vector(1, 0.8, 12),
            vang = Angle(90, 0, 0),
            wpos = Vector(1800, 200, -840),
            wang = Angle(-15, 0, -90)
        },
    },
    {
        ...
        Bone = "e11_sight",
        Offset = {
            vpos = Vector(0, 1.2, 20.5),
            vang = Angle(90, 0, -90),
            wpos = Vector(2700, 60, -1025),
            wang = Angle(-15, 0, 0)
        },
    },  
    {
    ...
    },    
    {
        ...
        Bone = "e11_sight",
        Offset = {
            vpos = Vector(0.9, 1.8, -4.3),
            vang = Angle(90, 0, -90),
            wpos = Vector(-300, 170, -255),
            wang = Angle(-15 , 0, 180)
        },
    },    
    {
        ...
        Bone = "e11_sight",
        Offset = {
            vpos = Vector(2.3, 1, -0.5),
            vang = Angle(90, 0, -90),
            wpos = Vector(50, 340, -440),
            wang = Angle(-15 , 0, 180)
        },
    },   
}
