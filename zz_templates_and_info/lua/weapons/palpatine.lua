...
SWEP.Category			= "[LSCS]"
SWEP.PrintName		= "Palpatines Lightsaber"
SWEP.Author			= "*Alastor*"
...
function SWEP:SetupDataTables()
	...
	if SERVER then
		self:SetHiltR("sidious") -- which hilt to use
		--self:SetHiltL("vibrosword") -- left hand hilt

		self:SetBladeR("sith") -- which blade to use 
		--self:SetBladeL("nanoparticles") --left hand blade

		self:SetStance("aggresive") -- assigns a permanent stance to this saber only. Ignoring what the player has in his inventory
	end
end
