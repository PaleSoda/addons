...
SWEP.Category			= "[LSCS]"
SWEP.PrintName		= "RG Lightsaber Pike"
SWEP.Author			= "*Alastor*"
...
function SWEP:SetupDataTables()
	...
	if SERVER then
		self:SetHiltR("zhrompike3") -- which hilt to use
		--self:SetHiltL("vibrosword") -- left hand hilt

		self:SetBladeR("pike") -- which blade to use 
		--self:SetBladeL("nanoparticles") --left hand blade

		self:SetStance("juggernaut") -- assigns a permanent stance to this saber only. Ignoring what the player has in his inventory
	end
end
